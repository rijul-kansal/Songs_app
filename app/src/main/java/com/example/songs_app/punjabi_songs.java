...
public class punjabi_songs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ls1=findViewById(R.id.list2);
        String []arr= {"Daku","Suit","8 parche","same Time Same jagha","Slowly Slowly"};
        ...
        ls1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                i.putExtra("Punjabi_songs_list",position);
                i.putExtra("song_type","punjabi");
                startActivity(i);
            }
        });
    }
